...
def render_document_view(contenu, type_doc, titre):
    ...
    if mime_type.startswith("image/"):
        ...
        # contenu). st.components.v1.html() crée un vrai iframe dédié au contenu
        # embarqué et fonctionne de façon fiable, en local comme sur Streamlit Cloud.
        ...
        st.caption("📌 Si l'aperçu ne s'affiche toujours pas (certains navigateurs mobiles ne supportent pas l'aperçu PDF intégré), utilisez le bouton de téléchargement ci-dessous.")
